...
- "definition": What the ${typeLabel} means AND what it does NOT mean (common misconceptions). 2-3 sentences. Do NOT use the ${typeLabel} itself, any of its inflected or derived forms, or its individual root words anywhere in the definition — describe the meaning without naming it, so it can be used as a clue.
